...
<body>
    ...
    <section class="section-1" id="myNav">
        <header>
            ...
            <nav class="navbar-default navbar-static-top navbar-fixed-top">
                <!-- pour ne pas revenir a son état initiale après f5-->
                <a href="#myNav" class="na active">Acceuil</a>
                <a href="#apropos" class="na">A&nbsppropos</a>
                <a href="#services" class="na">Services</a>
                <a href="#carouselExampleDark" class="na">Galerie</a>
                <a href="#team" class="na">Docteurs</a>
                <a href="#contact" class="na">Contact</a>
                <a href="#gallery" class="na">End</a>
            </nav>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown-content">
                                    @if (Auth::user()->role == 'Admin')
                                        <a href="{{ route('dashAdmin') }}"><i class="fa-solid fa-right-to-bracket"
                                                id="con4"></i>Dashboard </a>
                                    @elseif (Auth::user()->role == 'Patient')
                                        <a href="{{ route('dashP') }}"><i class="fa-solid fa-right-to-bracket"
                                                id="con4"></i>Dashboard </a>
                                    @elseif (Auth::user()->role == 'Assistant')
                                        <a href="{{ route('dashAssistant') }}"><i class="fa-solid fa-right-to-bracket"
                                                id="con4"></i>Dashboard </a>
                                    @elseif (Auth::user()->role == 'Doctor')
                                        <a href="{{ route('dashDoctor') }}"><i class="fa-solid fa-right-to-bracket"
                                                id="con4"></i>Dashboard </a>
                                    @endif

                                    <a href="{{ route('logout') }}"><i class="fa-solid fa-right-to-bracket"
                                            id="con3"></i>Se déconnecter </a>
                                </div>
                                ...
                                @else
                                    ...
                                    <div class="dropdown-content">
                                        ...
                                        <button type="button" class="btn" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal"><i class="fa-solid fa-right-to-bracket"
                                                id="con"></i>&nbsp Se connecter </button>
                                        @if (Route::has('signup'))
                                            {{-- <a href="#" data-toggle="modal" data-target="#exampleModal2" ><i class="fa-solid fa-user-plus" id="con2"></i>S'enregistrer</a>  --}}
                                            <button type="button" class="btn" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal2"><i class="fa-solid fa-user-plus"
                                                    id="con2"></i>&nbsp S'enregistrer </button>
                                        @endif
                                    @endauth
                                    @endif
                                </div>
    ...
    <!-- Pour l'element active de la nav-->
    <script>
    ...
    <!-- Pour le changement de la couleur de la navbar onscroll-->
    <script>
