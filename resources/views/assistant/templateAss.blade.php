        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('asPoint.index') }}">Tous les Rendez-vous</a>
                        <a class="collapse-item" href="{{ route('asPoint.create') }}">Ajouter Rendez-vous</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('Apatient.index') }}">Tous les patient</a>
                        <a class="collapse-item" href="{{ route('Apatient.create') }}">Ajouter patient</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('listdoc') }}">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <div class="d-flex flex-column">
                                    <span
                                        class="mr-4 d-none d-lg-block text-gray-600 small">{{ Auth::user()->name }}</span>
                                    <h5 class="mr-4 d-none d-lg-block text-primary small">{{ Auth::user()->role }}
                                    </h5>
                                </div>
