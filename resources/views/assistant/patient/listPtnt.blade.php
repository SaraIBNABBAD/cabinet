                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4 me-5">
                                                ...
                                                <select class="form-select" aria-label="Default select example"
                                                    name="sang">
                                                    <option value="O+"{{ $asPatient->sang === 'O+' ? 'selected' : '' }}>O+
                                                    </option>
                                                    <option value="O-"{{ $asPatient->sang === 'O-' ? 'selected' : '' }}>O-
                                                    </option>
                                                    <option value="A+"{{ $asPatient->sang === 'A+' ? 'selected' : '' }}>A+
                                                    </option>
                                                    <option value="A-"{{ $asPatient->sang === 'A-' ? 'selected' : '' }}>A-
                                                    </option>
                                                    <option value="B+"{{ $asPatient->sang === 'B+' ? 'selected' : '' }}>B+
                                                    </option>
                                                    <option value="B-"{{ $asPatient->sang === 'B-' ? 'selected' : '' }}>B-
                                                    </option>
                                                    <option value="AB+"{{ $asPatient->sang === 'AB+' ? 'selected' : '' }}>AB+
                                                    </option>
                                                    <option value="AB-"{{ $asPatient->gender === 'AB-' ? 'selected' : '' }}>
                                                        AB-</option>
