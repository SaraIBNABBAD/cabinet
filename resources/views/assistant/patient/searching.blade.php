...
@section('content')
    ...
    @endif
    <form action="{{ route('srchPatntAss') }}" method="get"
    ...
    <div class="h5 mb-0 font-weight-bold text-primary float-end me-5">{{ $sum }} Patient(s) trouvé(s)</div>
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="mb-4 table table-striped">
                ...
                <tbody class="text-center">
                    @foreach ($asPatient as $asPatient)
                        <tr>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-4">
                                                        <input type="text" id="floatingInput"
                                                            ...
                                                            value="{{ old('phone', $asPatient->phone) }}" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 ">
                                                    ...
                                                    <select class="form-select form-select-lg border-primary"
                                                        ...
                                                        <option
                                                            value="O+"{{ $asPatient->sang === 'O+' ? 'selected' : '' }}>
                                                            O+
                                                        </option>
                                                        <option
                                                            value="O-"{{ $asPatient->sang === 'O-' ? 'selected' : '' }}>
                                                        ...
                                                        <option
                                                            value="A+"{{ $asPatient->sang === 'A+' ? 'selected' : '' }}>
                                                            A+
                                                        </option>
                                                        <option
                                                            value="A-"{{ $asPatient->sang === 'A-' ? 'selected' : '' }}>
                                                        ...
                                                        <option
                                                            value="B+"{{ $asPatient->sang === 'B+' ? 'selected' : '' }}>
                                                            B+
                                                        </option>
                                                        <option
                                                            value="B-"{{ $asPatient->sang === 'B-' ? 'selected' : '' }}>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div
                                                        ...
                                                        <h6 class="mb-0 me-4">Sexe : <span class="text-danger">*</span>
                                                        </h6>
                                                ...
                                                <div class="col-md-6">
                                                    <div
                                                        ...
                                                        <div class="form-check form-check-inline mb-0 me-4">
                                                            <input class="form-check-input" type="radio"
                                                                name="mutuelle" id="non" value="non"
