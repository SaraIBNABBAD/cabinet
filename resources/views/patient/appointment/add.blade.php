...
<div class="card-body">
    <form method="POST" action="">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-floating mb-4">
                    <input type="tel" id="floatingInput" class="form-control form-control-lg"
        ...
        <div class="row ">
            ...
            <div class="col-md-6 mb-4">
                <div class="form-floating mb-4">
                    <input type="time" class="form-control form-control-lg" id="floatingInput"
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <select name="motif" id="" class="form-select" aria-label="Default select example">
