             ...
             <tbody>
                @foreach ($appnts as $appnt)
                    <tr>
                        ...
                        <td><a type="button" class="btn" data-toggle="modal" data-target="#update{{$appnt->id}}"><i class="fa-solid fa-pen-to-square text-info"></i></a>

  <!-- Modal -->
  <div class="modal fade" id="update{{$appnt->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('rendezVous.update', ['rendezVou'=>$appnt->id]) }}">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        @enderror"
                                id="floatingInput" placeholder="Date rendez-vous " name="time" value="{{old('time',$appnt->time)}}"/>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        @enderror"
                            ...
                            <option value="Consultation"{{ $appnt->motif === 'Consultation' ? 'selected' : '' }}>Consultation</option>
                            <option value="Traitement"{{ $appnt->motif === 'Traitement' ? 'selected' : '' }}>Traitement</option>
                        </select>
                        @error('motif')
                            <div class="alert alert-danger">
                                {{ $message }}
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary">Save changes</button>
                            ...
                            <a href="{{ route('rendezVous.create') }}" type="button" class="btn"><i class="fa-solid fa-square-plus text-success"></i></a>
                        </td> 
                    </tr>
                @endforeach
            </tbody> 
