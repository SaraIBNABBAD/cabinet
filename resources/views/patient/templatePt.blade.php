...
<<<<<<< HEAD
      ...
      <li class="nav-item">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                  ...
                  <a class="collapse-item" href="{{ route('rendezVous.index') }}">Tous les Rendez-vous</a>
                  <a class="collapse-item" href="{{ route('rendezVous.create') }}">Prendre Rendez-vous</a>
      ...
      <li class="nav-item">
          <a class="nav-link"  href="{{ route('myDoc') }}">
...
>>>>>>> 8cac15ceefa053c2ad6f7f62e403e551196aa4b0
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('dashP') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
