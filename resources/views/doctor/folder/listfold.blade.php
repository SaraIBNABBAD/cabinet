                    ...
                    @foreach ($folders as $folder)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <a href="{{ asset($folder->prescription) }}" target="_blank"><img
                                            src="{{ asset('img/PDF_logo-1.png') }}" width="40" height="40" /></a>
                                @endif
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                @else
                                    <a href="{{ asset($folder->balanceSheet) }}" target="_blank"><img
                                            src="{{ asset('img/PDF_logo-1.png') }}" width="40" height="40" /></a>
                                @endif
                            </td>
                            <td>
                                ...
                                <form action="{{ route('dFolder.destroy', ['dFolder' => $folder->id]) }}"
                                    class="d-inline" method="POST" id="folder{{ $folder->id }}">
                                    @csrf
                                    @method('delete')
                                    <button class="btn"
