...
@section('content')
    ...
    <div class="card-body">
         <!-- Topbar Search -->
    <form action="{{ route('searchPatnt') }}" method="get"
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select border-primary "
                                                    ...
                                                    <option value="O-"{{ $patient->sang === 'O-' ? 'selected' : '' }}>
                                                        O-</option>
                                                    <option value="A+"{{ $patient->sang === 'A+' ? 'selected' : '' }}>
                                                        A+</option>
                                                    <option value="A-"{{ $patient->sang === 'A-' ? 'selected' : '' }}>
                                                        A-</option>
                                                    <option value="B+"{{ $patient->sang === 'B+' ? 'selected' : '' }}>
                                                        B+</option>
                                                    <option value="B-"{{ $patient->sang === 'B-' ? 'selected' : '' }}>
                                                        B-</option>
                                                    <option
                                                        value="AB+"{{ $patient->sang === 'AB+' ? 'selected' : '' }}>AB+
                                                    </option>
                                                    <option
