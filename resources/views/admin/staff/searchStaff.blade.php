...
<div class="card-body">
    <!-- Topbar Search -->
    <form action="{{ url('searchStaff') }}" method="get"
        ...
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td><a type="button" class="btn" data-toggle="modal" data-target="#update{{ $staff->id }}"><i class="fa-solid fa-pen-to-square text-info"></i></a>
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('staffs.update', ['staff' => $staff->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-4">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg border-primary" id="floatingInput" placeholder="Nom complet" name="name" value="{{ old('name', $staff->name) }}" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-4">
                                                    <input type="text" id="floatingInput" class="form-control form-control-lg border-primary" placeholder="Téléphone" name="phone" value="{{ old('phone', $staff->phone) }}" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-floating mb-4">
                                                    <input type="text" class="form-control form-control-lg border-primary" id="floatingInput" placeholder="Adresse mail" name="email" value="{{ old('email', $staff->email) }}" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4 d-none">
                                                <div class="form-floating mb-4">
                                                    <input type="password" class="form-control form-control-lg border-primary" id="floatingInput" placeholder="Mot de passe" name="password" />
                                                    <label for="floatingInput">Mot de passe <span class="text-danger">*</span></label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-4 d-none">
                                                <div class="form-floating mb-4">
                                                    <input type="password" class="form-control form-control-lg border-primary" id="floatingInput" placeholder="Confirmer le mot de passe" name="confirmation_password" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-outline mb-4">
                                                    <label>Photo :</label>
                                                    <input type="file" id="picture" class="form-control form-control-lg border-primary" name="picture" accept="image/*" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-9">
                                                ...
                                                <select class="form-select border-primary" aria-label="Default select example" name="role">

                                                    <option value="Assistant" {{ $staff->role === 'Assistant' ? 'selected' : '' }}>Assistant
                                                    </option>
                    ...
                    <form action="{{ route('staffs.destroy', ['staff' => $staff->id]) }}" class="d-inline" method="POST" id="staff{{ $staff->id }}">
                        @csrf
                        @method('delete')
                        <button class="btn" type="button" onclick='handleDelete("staff{{ $staff->id }}")'><i class="fa-solid fa-trash text-danger"></i></button>
                    </form>
